...
def run_minio_job():
    ...
    job_config = ConfigFactory.from_dict({
        'extractor.minio.csv.{}'.format(MinioStatsExtractor.ACCESS_KEY):
            'myaccesskey',
        'extractor.minio.csv.{}'.format(MinioStatsExtractor.SECRET_KEY):
            'mysecretkey',
        'extractor.minio.csv.{}'.format(MinioStatsExtractor.BUCKET_NAME):
            'dev-raw-data',
